...
if (anu.action == 'add') {
Manik.sendMessage(anu.id, { image: Kon, contextInfo: { mentionedJid: [num] }, caption: `Welcome To ${metadata.subject} @${num.split("@")[0]}

Description: ${metadata.desc}

Welcome `} )
} else if (anu.action == 'remove') {
Manik.sendMessage(anu.id, { image: Tol, contextInfo: { mentionedJid: [num] }, caption: `@${num.split("@")[0]} Left ${metadata.subject}
